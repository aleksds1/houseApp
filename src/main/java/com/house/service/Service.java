...
public class Service implements ServiceInterface {
    ...
    //Тестовые дома
    public List<House> createTestHomes(){
        ...
        List<Room> temp2 = new ArrayList<Room>();
        temp2.add(room3);
        temp2.add(room4);
        ...
        List<Room> temp3 = new ArrayList<Room>();
        temp3.add(room5);
        temp3.add(room6);
        ...
        List<Room> temp4 = new ArrayList<Room>();
        temp4.add(room7);
        temp4.add(room8);
        ...
        List<Room> temp5 = new ArrayList<Room>();
        temp5.add(room9);
        temp5.add(room10);
        ...
        List<Room> temp7 = new ArrayList<Room>();
        temp7.add(room13);
        temp7.add(room14);
        ...
        List<Room> temp9 = new ArrayList<Room>();
        temp9.add(room17);
        temp9.add(room18);
        ...
        List<Room> temp10 = new ArrayList<Room>();
        temp10.add(room19);
        temp10.add(room20);
        ...
        List<Room> temp11 = new ArrayList<Room>();
        temp11.add(room21);
        temp11.add(room22);
